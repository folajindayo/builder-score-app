...
const BuilderScore = dynamic(
  () => import('@/components/BuilderScore').then((mod) => ({ default: mod.BuilderScore })),
  {
    loading: () => (
      <div className="p-8 bg-white rounded-xl border-2 border-gray-200 shadow-md animate-pulse">
        Loading...
      </div>
    ),
  }
      ...
      >
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500">
            Connect your wallet to view your onchain builder reputation score powered by Talent
            Protocol
          </p>
        </div>
