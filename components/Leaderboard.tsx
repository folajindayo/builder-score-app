          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="px-3 py-2 text-sm bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-200 rounded-xl transition-colors flex items-center gap-1.5 shadow-sm"
              ...
              <button
                onClick={handlePrint}
                className="px-3 py-2 text-sm bg-yellow-50 hover:bg-yellow-100 text-yellow-700 border border-yellow-200 rounded-xl transition-colors flex items-center gap-1.5 shadow-sm"
